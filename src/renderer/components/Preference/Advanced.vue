			...
			<el-form
				...
				<el-form-item
					...
					<el-switch
						...
						@change="onProxyEnableChange"></el-switch>
				</el-form-item>
				<el-form-item
					:label-width="formLabelWidth"
					...
					<el-col
						...
						<el-input
							...
							v-model="form.proxy.server"></el-input>
					</el-col>
					<el-col
						class="form-item-sub"
						:xs="24"
						...
						<el-input
							...
							v-model="form.proxy.bypass"></el-input>
					</el-col>
					<el-col
						class="form-item-sub"
						:xs="24"
				...
				<el-form-item
					...
					<div class="form-item-sub bt-tracker">
						...
						<el-input
							...
							v-model="form.btTracker"></el-input>
						<div
							class="el-form-item__info"
							style="margin-top: 8px">
					...
					<el-row style="margin-bottom: 8px">
						<el-col
							...
							<el-switch
								...
								active-text="UPnP/NAT-PMP"></el-switch>
						</el-col>
					</el-row>
					<el-row style="margin-bottom: 8px">
						<el-col
				...
				<el-form-item
					...
					<el-col
						...
						<el-switch
							...
							@change="val => onProtocolsChange('magnet', val)"></el-switch>
					</el-col>
					<el-col
						class="form-item-sub"
						:span="24">
						<el-switch
							...
							@change="val => onProtocolsChange('thunder', val)"></el-switch>
					</el-col>
				</el-form-item>
				<el-form-item
					...
					<el-col
						...
						<el-input
							...
							v-model="form.userAgent"></el-input>
...
import {EMPTY_STRING, ENGINE_RPC_PORT, LOG_LEVELS, TRACKER_SOURCE_OPTIONS, PROXY_SCOPE_OPTIONS} from '@shared/constants'
import {
	buildRpcUrl,
	calcFormLabelWidth,
	changedConfig,
