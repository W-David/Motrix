				...
				<el-col
					...
					<el-form-item
						...
						<el-input-number
							...
							:label="$t('task.task-split')"></el-input-number>
					</el-form-item>
				</el-col>
			</el-row>
			<el-form-item
			...
			<div
				...
				<el-form-item
					...
					<el-input
						...
						v-model="form.authorization"></el-input>
				</el-form-item>
				<el-form-item
					...
					<el-col
						...
						<el-form-item
							...
							<el-input
								...
								v-model="form.allProxy"></el-input>
						</el-form-item>
					</el-col>
					<el-col
						:span="8"
